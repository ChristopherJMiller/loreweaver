 ...
 *
 * Enhanced section editor with AI expansion capabilities.
...
export interface SectionEditorWithExpansionProps {
  id: string;
  title: string;
  content: string;
...
export function SectionEditorWithExpansion({
  id,
  title,
  content,
  onChange,
  ...
  className,
  hideTitle = false,
}: SectionEditorWithExpansionProps) {
